  ...
  <div class="wrap">
    ...
    <div class="cols">
      ...
      <div><h4>About</h4>
        ...
        <a href="<?php echo esc_url( home_url( '/about-us' ) ); ?>">About us</a><a href="<?php echo esc_url( home_url( '/contact' ) ); ?>">Contact</a><a href="<?php echo esc_url( home_url( '/privacy' ) ); ?>">Privacy</a>
        <?php } ?>
      </div>
    </div>
  </div>
